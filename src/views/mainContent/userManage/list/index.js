  ...
  onTableChange(data) {
    if (data.type === "page" || data.type === "pageSize") {
      ...
      if (data.data.type === "date") {
        ...
        let value = _.isArray(data.data.value)
      ...
      <div className="user-manage-list">
        <div className="flex filter-wrap">
          <div className="flex filter-left">
            ...
            <CButton
              type="danger"
              authId="userManageListBatchDelete"
          ...
          <div className="flex filter-right">
            <CInput
              ...
              type="search"
              placeholder={this.state.searchData.placeholder}
              onEnter={this.searchHandler}
            />
            <CButton type="primary" onClick={this.resetHandler}>
              重置
            </CButton>
          </div>
        </div>
            ...
            render={(text, record, index) => (
              <div className="isActive">
                <CSwitch
                  ...
                  onChange={(value) => this.editActiveChange(value, record)}
                />
              </div>
            )}
          />
          <div
            ...
            render={(text, record, index) => (
              <div className="operate">
                <CButton type="text" onClick={() => this.detailHandler(record)}>
                  查看
                </CButton>
                <CButton
                  type="text"
                  authId="userManageListEdit"
